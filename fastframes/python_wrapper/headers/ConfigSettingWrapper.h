...
class ConfigSettingWrapper {
    public:
        ...
        /**
         * @brief Get path to the histogram filelist
         *
         * @return std::string - path to the histogram filelist
         */
        std::string inputHistFilelistPath() const   {
            return m_configSetting->inputHistFilelistPath();
        };
        ...
        /**
         * @brief Set path to the histogram filelist
         *
         * @param inputHistFilelistPath - path to the filelist
         */
        void setInputHistFilelistPath(const std::string &inputHistFilelistPath) {
            m_configSetting->setInputHistFilelistPath(inputHistFilelistPath);
        };
        ...
        void addXsectionFiles(const std::vector<std::string>& xsectionFiles, const std::vector<std::string> &campaigns) {
            m_configSetting->addXsectionFiles(xsectionFiles, campaigns);
        };
         ...
         */
        std::vector<std::string> xSectionFilesPreview() const {
            std::vector<std::string> result;
            const std::map<std::vector<std::string>,std::vector<std::string>> &xSectionFilesData = m_configSetting->xSectionFiles();
            for (const auto& [campaigns, xsection_files] : xSectionFilesData) {
                const std::string campaignsString = StringOperations::joinStrings(",", campaigns);
                const std::string xsectionFilesString = StringOperations::joinStrings(",", xsection_files);
                result.push_back(campaignsString + " : " + xsectionFilesString);
            }
            return result;
        };
