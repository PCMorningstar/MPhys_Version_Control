...
class TruthWrapper  {
    public:
        ...
        /**
         * @brief Add variables for 2D histograms
         *
         * @param var1
         * @param var2
         */
        void addVariableCombination(const std::string& var1, const std::string& var2) {
            m_truth->addVariableCombination(var1, var2);
        };

        /**
         * @brief Get variables for 2D histograms
         *
         * @return const std::vector<std::string>
         */
        std::vector<std::string> variableCombinations() const {
            const std::vector<std::pair<std::string,std::string>> &combinations = m_truth->variableCombinations();
        ...
        /**
         * @brief Add variables for TProfile
         *
         * @param var1
         * @param var2
         */
        void addVariableForProfile(const std::string& var1, const std::string& var2) {
            m_truth->addVariableForProfile(var1, var2);
        };

        /**
         * @brief Get variables for TProfile
         *
         * @return const std::vector<std::string >
         */
        std::vector<std::string> variablesForProfile() const {
            const std::vector<std::pair<std::string,std::string>> &combinations = m_truth->variablesForProfile();
            std::vector<std::string> combinations_python;
            for (const std::pair<std::string,std::string> &combination : combinations) {
                combinations_python.push_back(combination.first + ", "+ combination.second);
            }
            return combinations_python;
        };
        ...
        /**
         * @brief Add variables for 3D histograms
         *
         * @param var1
         * @param var2
         * @param var3
         */
        void addVariableCombination3D(const std::string& var1, const std::string& var2, const std::string& var3) {
            m_truth->addVariableCombination3D(var1, var2, var3);
        };
        ...
        std::vector<std::string> variableCombinations3D() const {
            const std::vector<std::tuple<std::string,std::string,std::string>> &combinations = m_truth->variableCombinations3D();
            std::vector<std::string> combinations_python;
            for (const auto &combination : combinations) {
