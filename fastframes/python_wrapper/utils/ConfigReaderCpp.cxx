...
BOOST_PYTHON_MODULE(ConfigReaderCpp) {
    ...
    class_<ConfigSettingWrapper>("ConfigSettingWrapper",
        ...
        // inputHistFilelistPath
        .def("inputHistFilelistPath",   &ConfigSettingWrapper::inputHistFilelistPath)
        .def("setInputHistFilelistPath",&ConfigSettingWrapper::setInputHistFilelistPath)
        ...
        // x-section files
        .def("addXsectionFiles",            &ConfigSettingWrapper::addXsectionFiles)
        .def("xSectionFilesPreview",        &ConfigSettingWrapper::xSectionFilesPreview)
    ...
    class_<RegionWrapper>("RegionWrapper",
        ...
        .def("addVariableForProfile",   &RegionWrapper::addVariableForProfile)
        .def("variablesForProfile",     &RegionWrapper::variablesForProfile)
    ;
    ...
    class_<VariableWrapper>("VariableWrapper",
        ...
        // underOverFlowType
        .def("underOverFlowType",       &VariableWrapper::underOverFlowType)
        .def("setUnderOverFlowType",    &VariableWrapper::setUnderOverFlowType)
    ;
    ...
    class_<SampleWrapper>("SampleWrapper",
        ...
        .def("setCheckTree", &SampleWrapper::setCheckTree)
        .def("checkTree",    &SampleWrapper::checkTree)
    ;
    ...
    class_<TruthWrapper>("TruthWrapper",
        ...
        // addVariableCombination
        .def("addVariableCombination",  &TruthWrapper::addVariableCombination)
        .def("variableCombinations",    &TruthWrapper::variableCombinations)

        // addVariableCombination3D
        .def("addVariableCombination3D",&TruthWrapper::addVariableCombination3D)
        .def("variableCombinations3D",  &TruthWrapper::variableCombinations3D)

        .def("addVariableForProfile",   &TruthWrapper::addVariableForProfile)
        .def("variablesForProfile",     &TruthWrapper::variablesForProfile)
    ;
