...
namespace Utils {
   ...
   * @return std::pair<Variable, Variable>
   */
  std::pair<Variable, Variable> get2DVariablesByNameTruth(const std::shared_ptr<Sample>& sample,
                                                          const std::string& variableName);
   ...
   * @return std::vector<std::string>
   */
  std::vector<std::string> getBranchesFromFile(const std::unique_ptr<TFile>& file,
                                               const std::string& treeName);
