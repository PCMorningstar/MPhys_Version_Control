...
public:
   ...
   * @param var2
   */
  inline void addVariableCombination(const std::string& var1, const std::string& var2) {m_variableCombinations.emplace_back(std::make_pair(var1, var2));}
   ...
   * @param var2
   */
  inline void addVariableForProfile(const std::string& var1, const std::string& var2) {m_variableForProfile.emplace_back(std::make_pair(var1, var2));}
   ...
   * @param var3
   */
  inline void addVariableCombination3D(const std::string& var1, const std::string& var2, const std::string& var3) {m_variableCombinations3D.emplace_back(std::make_tuple(var1, var2, var3));}

  /**
   * @brief Get variables for 3D histograms
   *
