...
public:
  ...
  /**
   * @brief Updates the maps of systematics <-> branches maps
   * Only adds the entries to the map if they do not exist already
   *
   * @param path
   * @param treeName
   * @param systematics
   */
  void addSystematicMapFromFile(const std::string& path,
                                const std::string& treeName,
                                const std::vector<std::shared_ptr<Systematic> >& systematics);
  ...
  /**
   * @brief Add new branches to the map of systematics <-> branches
   *
   * @param variables
   * @param systematics
   */
  void addMatchSystematicVariables(const std::vector<std::string>& variables,
                                   const std::vector<std::shared_ptr<Systematic> >& systematics);
