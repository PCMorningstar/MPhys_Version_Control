 ...
 */
 ...
 private:
    ...
    * @return std::tuple<std::vector<SystematicHisto>, RegionHisto, std::vector<CutflowContainer>, ROOT::RDF::RNode, std::vector<std::pair<TChain*, TTreeIndex*> > >
    ...
    * @return RegionHisto
    */
   RegionHisto processTruthHistos(const std::vector<std::string>& filePaths,
                                  const std::shared_ptr<Sample>& sample,
                                  const UniqueSampleID& id);
   ...
   /**
    * @brief Book 1d histograms for truth
    *
    * @param node
    * @param variable
    * @param truth
   ...
   /**
    * @brief Book 2d histograms for truth
    *
    * @param node
    * @param variable1
    * @param variable2
    ...
    * @return ROOT::RDF::RResultPtr<TH2D>
    */
   ROOT::RDF::RResultPtr<TH2D> book2DhistoTruth(ROOT::RDF::RNode node,
                                                const Variable& variable1,
                                                const Variable& variable2,
                                                const std::shared_ptr<Truth>& truth) const;
   ...
   /**
    * @brief Book TProfile histograms using the JIT compiler for truth
    *
    * @param node
    * @param variable1
    * @param variable2
    ...
    * @return ROOT::RDF::RResultPtr<TProfile>
    */
   ROOT::RDF::RResultPtr<TProfile> bookProfilehistoTruth(ROOT::RDF::RNode node,
                                                         const Variable& variable1,
                                                         const Variable& variable2,
                                                         const std::shared_ptr<Truth>& truth) const;
   ...
   /**
    * @brief Book 3D histograms using the JIT compiler for truth
    *
    * @param node
    * @param variable1
    * @param variable2
    ...
    * @return ROOT::RDF::RResultPtr<TH3D>
    */
   ROOT::RDF::RResultPtr<TH3D> book3DhistoTruth(ROOT::RDF::RNode node,
                                                const Variable& variable1,
                                                const Variable& variable2,
                                                const Variable& variable3,
                                                const std::shared_ptr<Truth>& truth) const;
   ...
   /**
    * @brief Add branches from the truth trees to the map of systematics <-> branches
    *
    * @param filePath
    * @param sample
    */
   void addTruthBranchesToMap(const std::string& filePath,
                              const std::shared_ptr<Sample>& sample);
 
   /**
    * @brief Get the definition of a variable and see if it is a formula that needs to be
    * evaluated. Also does the <truth_tree>.<branch> processing
    *
    * @param variable
    * @param truth
    * @return std::string
    */
   std::string definitionVariableTruth(const Variable& variable,
                                       const std::shared_ptr<Truth>& truth) const;
